...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<string, EffectInfo> EffectsMap = new Dictionary<string, EffectInfo>()
        {
            ...
            { "global_arson", new EffectInfo("This Is Fine", EffectCategory.Misc, true, true)},
            { "changinggravity", new EffectInfo("Changing Gravity", EffectCategory.Misc, true, true)},
            { "misc_big_bang", new EffectInfo("Big Bang", EffectCategory.Misc)},           
            { "veh_honkfield", new EffectInfo("Honk Field", EffectCategory.Vehicle, true, false)},
            { "misc_lagspikes", new EffectInfo("Lagspikes", EffectCategory.Misc, true, false)},
            { "misc_crashroulette", new EffectInfo("Crash Roulette", EffectCategory.Misc)},
            { "misc_blueballed", new EffectInfo("Get Blueballed", EffectCategory.Misc, true)},
            { "player_spamclothes", new EffectInfo("What Clothes Do I Wear", EffectCategory.Player, true)},
            { "tp_altruistcamp", new EffectInfo("Teleport To Altruist Camp", EffectCategory.Player)},
            { "tp_playboymansion", new EffectInfo("Teleport To Playboy Mansion", EffectCategory.Player)},
            { "peds_chancejesus", new EffectInfo("Spawn 70/30 Jesus", EffectCategory.Peds)},
            { "player_suffer", new EffectInfo("Suffering", EffectCategory.Player, true, true)},
            { "misc_fullassault", new EffectInfo("Full Police Assault", EffectCategory.Misc, true, true)},
            { "peds_vehthieves", new EffectInfo("Vehicle Thieves", EffectCategory.Peds)},
            { "player_busted", new EffectInfo("Jailtime", EffectCategory.Player, true)},
            { "misc_shrinkcam", new EffectInfo("Shrinking Camera", EffectCategory.Misc, true, true)},
            { "misc_hyperaccel", new EffectInfo("Hyper Acceleration", EffectCategory.Misc, true)},
