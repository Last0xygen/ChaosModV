...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_MISC_CHANGING_GRAVITY,
            EFFECT_MISC_GLOBAL_ARSON,
            EFFECT_VEH_HONK_FIELD,
            EFFECT_MISC_LAGSPIKES,
            EFFECT_MISC_CRASHROULETTE,
            EFFECT_MISC_BLUEBALLED,
            EFFECT_PLAYER_SPAMCLOTHES,
            EFFECT_TP_ALTRUISTCAMP,
            EFFECT_PEDS_CHANCEJESUS,
            EFFECT_TP_PLAYBOYMANSION,
            EFFECT_PLAYER_SUFFER,
            EFFECT_MISC_FULLASSAULT,
            EFFECT_PEDS_VEHTHIEVES,
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_ANGRY_JESUS2, new EffectInfo("Spawn Godly Griefer Jesus", EffectCategory.PEDS, "spawn_grieferjesus2")},
            ...
            {EffectType.EFFECT_PLAYER_LAUNCH, new EffectInfo("Yeet Player Up", EffectCategory.PLAYER, "player_upupaway")},
            ...
            {EffectType.EFFECT_INVERTVELOCITY, new EffectInfo("Invert Current Velocity x 4", EffectCategory.MISC, "invertvelocity")},
            ...
            {EffectType.EFFECT_VEH_SET_TOPSPEED_30MPH, new EffectInfo("20MPH Speed Limit", EffectCategory.VEHICLE, "veh_30mphlimit", true, true) },
            ...
            {EffectType.EFFECT_MISC_CREDITS, new EffectInfo("Roll Credits", EffectCategory.MISC, "misc_credits", true)},
            ...
            {EffectType.EFFECT_PLAYER_FORCEFIELD, new EffectInfo("White Hole", EffectCategory.PLAYER, "player_forcefield", true, true)},
            ...
            {EffectType.EFFECT_MISC_CRASH,  new EffectInfo("Almost Fake Crash", EffectCategory.MISC, "misc_fakecrash")},
            {EffectType.EFFECT_PLAYER_GRAVITY,  new EffectInfo("Black Hole", EffectCategory.PLAYER, "player_gravity", true, true)},
            ...
            {EffectType.EFFECT_MISC_QUICK_SPRUNK_STOP, new EffectInfo("Quick Sprunk Stops", EffectCategory.MISC, "misc_quick_sprunk_stop", true)},
            ...
            {EffectType.EFFECT_PLAYER_ROCKET, new EffectInfo("Rocket Man Forgot His Parachute", EffectCategory.PLAYER, "player_rocket")},
            ...
            {EffectType.EFFECT_MISC_CHANGING_GRAVITY, new EffectInfo("Changing Gravity", EffectCategory.MISC, "changinggravity", true, true)},
            {EffectType.EFFECT_MISC_GLOBAL_ARSON, new EffectInfo("This Is Fine", EffectCategory.MISC, "global_arson", true, true)},
            {EffectType.EFFECT_VEH_HONK_FIELD, new EffectInfo("Honk Field", EffectCategory.VEHICLE, "veh_honkfield", true, false)},
            {EffectType.EFFECT_MISC_LAGSPIKES, new EffectInfo("Lagspikes", EffectCategory.MISC, "misc_lagspikes", true, false)},
            {EffectType.EFFECT_MISC_CRASHROULETTE, new EffectInfo("Crash Roulette", EffectCategory.MISC, "misc_crashroulette")},
            {EffectType.EFFECT_MISC_BLUEBALLED, new EffectInfo("Get Blueballed", EffectCategory.MISC, "misc_blueballed", true)},
            {EffectType.EFFECT_PLAYER_SPAMCLOTHES, new EffectInfo("What Clothes Do I Wear", EffectCategory.PLAYER, "player_spamclothes", true)},
            {EffectType.EFFECT_TP_ALTRUISTCAMP, new EffectInfo("Teleport To Altruist Camp", EffectCategory.PLAYER, "tp_altruistcamp")},
            {EffectType.EFFECT_TP_PLAYBOYMANSION, new EffectInfo("Teleport To Playboy Mansion", EffectCategory.PLAYER, "tp_playboymansion")},
            {EffectType.EFFECT_PEDS_CHANCEJESUS, new EffectInfo("Spawn 70/30 Jesus", EffectCategory.PEDS, "peds_chancejesus")},
            {EffectType.EFFECT_PLAYER_SUFFER, new EffectInfo("Suffering", EffectCategory.PLAYER, "player_suffer", true, true)},
            {EffectType.EFFECT_MISC_FULLASSAULT, new EffectInfo("Full Police Assault", EffectCategory.MISC, "misc_fullassault", true, true)},
